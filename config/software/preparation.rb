...
build do
  ...
  block do
    ...
    %w{openssl libssl-dev zlib1g zlib1g-dev libyaml-0-2 libyaml-dev build-essential libaugeas0 libaugeas-dev pkg-config libreadline6 libreadline6-dev libncurses5 libncurses5-dev}.each do |package|
